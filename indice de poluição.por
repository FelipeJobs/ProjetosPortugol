...
*/
	...
	funcao inicio()
	{
		...
		se(indice >= 0.05 e indice <= 0.25){
			escreva("Todos os setores podem continuar atuando normalmente")
		}
		se(indice >= 0.3 e indice <0.4){
			escreva("O primeiro setor deve suspender as suas atividades")
		}
		se(indice >= 0.4 e indice < 0.5){
			escreva("O primeiro setor e o segundo devem suspender suas atividades")
		}
		senao{
			escreva("Todos os setores devem suspender suas atividades")
		}
		}}
